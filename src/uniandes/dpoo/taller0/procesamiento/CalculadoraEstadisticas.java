...
public class CalculadoraEstadisticas
{
	...
	/**
	 * Consulta cuál es el país de un determinado nombre de un atleta
	 * 
	 * @param nombreAtleta   El nombre del atleta de interés.
	 * 
	 * @return Retorna el nombre del país al que representa dicho atleta
	 * 
	 */
	
	public String paisSegunAtleta(String nombreAtleta)
	{
		Atleta elAtleta = buscarAtleta(nombreAtleta);
		Pais elPais = elAtleta.darPais();
		
		String nombrePais = elPais.darNombre();
