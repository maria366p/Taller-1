...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar el país según el nombre del Atleta");
		System.out.println("14. Salir de la aplicación\n");
		
	}
	
	/**
	 * Le muestra a el usuario el nombre del país al cual representa el atleta consultado
	 */
	
	private void ejecutarPaisdeAtleta()
	{
		System.out.println("\n" + "País al que pertenece dicho atleta" + "\n");
		
		
		String nombreAtleta = input("Por favor ingrese el nombre de un atleta");
		String nombrePais = calculadora.paisSegunAtleta(nombreAtleta);
		System.out.println("El pais al que representa dicho atleta es " + nombrePais);
